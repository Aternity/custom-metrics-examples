...
// CMX. See the MarshalJSON for details. TagValue is used for the values of
// CMX tags as well as for CMX metric names.
type TagValue model.LabelValue

// MarshalJSON marshals this TagValue into JSON that only contains runes allowed
// in CMX. It implements json.Marshaler. The runes allowed in CMX are
...
//
// - If a byte represents a legal CMX rune with the exception of '_', that
...
//
// This encoding allows to save arbitrary Go strings in CMX. That's
...
// in CMX strings). The encoding uses '_' as an escape character and
...
// UnmarshalJSON unmarshals JSON strings coming from CMX into Go strings
